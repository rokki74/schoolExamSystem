...
try {
    ...
    const sql = "INSERT INTO results(exam_id, subject_id, admission_number, marks) VALUES(?, ?, ?, ?)";
    const params = [examExists.exam_id, subjectExists.subject_id, admNoExists.admission_number, marks];
